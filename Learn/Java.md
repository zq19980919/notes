...
## 8.6 实例变量赋值位置与赋值顺序
## 8.7 final关键字的使用
## 8.8 abstract关键字修饰类、方法
## 8.9 抽象的应用举例与模板方法的设计模式
## 8.10 接口的理解与基本语法
## 8.11 接口的应用举例（体现多态、匿名实现类的创建、面试题）
## 8.12 jdk8，jdk9中接口的新特性
## 8.13 类的成员之五：内部类
## 8.14 枚举类的使用(自定义、enum)
## 8.15 枚举类常用方法、实现接口
## 8.16 注解的理解和三个常用注解
## 8.17 元注解与自定义注解应用举例
## 8.18 JUnit单元测试的使用
## 8.19 包装类的理解、基本数据类型与包装类的转换
## 8.20 基本数据类型、包装类与String类之间的转换
